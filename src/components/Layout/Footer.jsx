      ...
      <div className="max-w-6xl mx-auto text-center md:text-left"> {/* Centraliza em mobile, alinha à esquerda em md+ */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8"> {/* Grid para as colunas */}
          ...
          <div className="mb-6 md:mb-0">
            <h5 className="text-2xl font-bold mb-2 text-amber-400">Associação Rafeira</h5> {/* Usando text-amber-400 do v0.dev */}
          ...
          <div className="mb-6 md:mb-0">
            ...
            <ul className="list-none p-0 space-y-2"> {/* space-y-2 para espaçamento entre links */}
              <li><Link to="/about" className="text-gray-400 hover:text-amber-400 transition-colors">Sobre Nós</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-2">E-mail das co-diretoras artísticas: </p>
            <p className="text-gray-400 text-sm mb-2">clara.passarinho@gmail.com /</p>
            <p className="text-gray-400 text-sm mb-2">andreiabaptistagalvao@gmail.com</p>
            <p className="text-gray-400 text-sm mb-2">Telefones: +351 962 185 565 / +351 961 200 611</p>
            <p className="text-gray-400 text-sm">Formulário de contacto direto (nome, e-mail, mensagem)</p>
          </div>
        </div>
